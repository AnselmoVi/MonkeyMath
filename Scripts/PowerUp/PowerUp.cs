...
public class PowerUp : MonoBehaviour
{
    ...
    public void CollisioneAvvenuta(Collision collision)
    {
        ...
        GameObject.Find("TimerText").GetComponent<TIMERgame>().TimeAdd(bonus); // Aggiungi il tempo bonus
        GameObject.Find("ManagerPowerUp").GetComponent<ManagerPowerUp>().SetTouch(); // Setta la condizione per far nascere un nuovo PowerUp
